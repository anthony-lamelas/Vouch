...
const stats: Stats = {
  ...
  requests_active: 1,
  by_status: [
    { status: 'requested', label: 'Requested', count: 0 },
    { status: 'employee_accepted', label: 'Employee accepted', count: 0 },
    { status: 'employee_declined', label: 'Employee declined', count: 0 },
    { status: 'contacted', label: 'Contacted', count: 0 },
    { status: 'candidate_interested', label: 'Candidate interested', count: 1 },
    { status: 'candidate_declined', label: 'Candidate declined', count: 0 },
    { status: 'no_response', label: 'No response', count: 0 },
